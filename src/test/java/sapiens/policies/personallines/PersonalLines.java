        ...
        try {
            if (exists("linkNewProposal", true, "New Proposal Link")) {
                ...
                if (exists("labelGeneralDetails", true, "General Details ")) {
                    ...
                    }else if (productType.equalsIgnoreCase("Absa idirect")) {
...
//                    }
                    ...
                    selectValueFromDropdown("drpDwnExternalDoorMainDwelling", "text", externalDoorMainDwelling, "Select Burglar Bars Outbuilding");
...
//                    click("chkBoxRequireCreditShortFall", "Click Require Credit ShortFall ?");
    ...
    public void questionnaire_PrivateInsure() {
        ...
        public void questionnaire_Idirect() {
            ...
            try {
                setText("drpDwnQuestion1_AbsaIdirect",question1, "Select Answer of Question 1");
                setText("drpDwnQuestion2_AbsaIdirect",question2, "Select Answer of Question 2");
                setText("drpDwnQuestion3_AbsaIdirect",question3, "Select Answer of Question 3");
                setText("drpDwnQuestion4_AbsaIdirect",question4, "Select Answer of Question 4");
